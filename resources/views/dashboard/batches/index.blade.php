...
@section('content')
                ...
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li><a href="{{ url('/dashboard/batches/create') }}" class="btn  btn-primary "><em class="icon ni ni-plus-circle"></em><span>Add New Batch</span></a></li>
    ...
    <div class="nk-block">
        <div class="card bg-white card-bordered card-stretch">
                    ...
                    <table class="nk-tb-list nk-tb-ulist">
                        ...
                        @if(count($batches ) > 0)
                            ...
                            <td class="nk-tb-col tb-col-mb">
                                <span> <a href="{{ url('dashboard/batch/'.$batch->id.'/timings') }}" class=" btn btn-sm btn-primary ">Manage Timings</a> </span>
                            </td>
                            <td class="nk-tb-col tb-col-mb">
                                <span>20.4.2021</span>
                            </td>
